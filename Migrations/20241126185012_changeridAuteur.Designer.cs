...
namespace ProjetSynthese.Server.Migrations
{
    ...
    [Migration("20241126185012_changeridAuteur")]
    partial class changeridAuteur
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjetSynthese.Server.Models.Activite", b =>
                {
                    ...
                    b.Property<string>("AuteurUtilisateurId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("AuteurUtilisateurId");
            ...
            modelBuilder.Entity("ProjetSynthese.Server.Models.Question.QuestionTroue", b =>
                {
                    ...
                    b.ToTable("Questions", t =>
                        {
                            t.Property("ReponseTexte")
                                .HasColumnName("QuestionTroue_ReponseTexte");
                        });
            ...
            modelBuilder.Entity("ProjetSynthese.Server.Models.Reponse.ReponseTroue", b =>
                {
                    ...
                    b.ToTable("Reponses", t =>
                        {
                            t.Property("PositionTexte")
                                .HasColumnName("ReponseTroue_PositionTexte");
                        });
            ...
            modelBuilder.Entity("ProjetSynthese.Server.Models.Activite", b =>
                {
                    b.HasOne("ProjetSynthese.Server.Models.Enseignant", "Auteur")
                        ...
                        .HasForeignKey("AuteurUtilisateurId")
                        .HasPrincipalKey("UtilisateurId")
                        .OnDelete(DeleteBehavior.Restrict);
